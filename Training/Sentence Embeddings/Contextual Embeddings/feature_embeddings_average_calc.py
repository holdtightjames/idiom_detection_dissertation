...
# =============================================================================
#  Code to get the mean of feature vectors in the context embeddings
#  The context embeddings generated from the target sentences in sem_eval dataset
# =============================================================================

# Retrieves the TSV file containing all the sentence embeddings 
sentence_embeddings_output = pd.read_csv('context_sentence_embeddings.tsv', sep='\t')
...
with open('context_features_mean.csv', 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
